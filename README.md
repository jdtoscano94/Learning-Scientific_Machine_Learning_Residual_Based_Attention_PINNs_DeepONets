...
This repository will help you get involved in the physics-informed machine learning world. In particular, it is a step-by-step guide that covers some basic concepts needed to run a PINN in Pytorch (from approximating functions, solving PDEs, forward and Inverse problems using a  physics-informed neural network).
