...
This repository will help you get involved in the physics-informed machine learning world. In particular, it is a step-by-step guide that covers the base knowledge to run a PINN in Pytorch (from approximating functions to solving PDEs).
